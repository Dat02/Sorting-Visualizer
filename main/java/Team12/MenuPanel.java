...
public class MenuPanel extends JPanel {
    ...
    private static String[] s = { "Bubble Sort", "Merge Sort", "Quick Sort", "Selection Sort" };
    public static JComboBox<String> chooseComboBox;
    private static String[] s1 = { "Increase", "Decrease" };
    public static JComboBox<String> chooseComboBox1;
    private static String[] s2 = { "First", "Middle", "Last" };
    ...
    public MenuPanel() {
        ...
        typeSorting.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                ...
                if (str.equals("Quick Sort"))
                    chooseComboBox1.setEnabled(true);
                else
                    chooseComboBox1.setEnabled(false);
            }
        });
        ...
        mixSubmit.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == 1) {
                    SubmitPanel.mixSubmit = true;
                } else {
                    SubmitPanel.mixSubmit = false;
                }
            }
        });
